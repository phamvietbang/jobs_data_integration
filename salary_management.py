...
if __name__ == '__main__':
    path = 'data/alljob.json'
    salary_management = SalaryManagement(path)
    valid_records = salary_management.get_salary(5e6, 10e6, num_records=20)
    valid_df = pd.concat(valid_records)
    valid_df.to_csv("valid_record.csv", encoding='utf-8-sig')
